...
function generatePrompt(animal) {
  return `Write a letter from my dnd character (Lu) to her mentor Talia of about 130 words consisting of what happened in our last session. Here is a brief description of our player characters:
